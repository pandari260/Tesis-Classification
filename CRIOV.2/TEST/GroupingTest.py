...
class ClusteringTest(unittest.TestCase):
    ...
    def test_createGroups_MoreNumberOfGroupssThanClusters3D_SeveralClusters(self):
    ...
    def test_createGroups_MoreNumberOfGroupssThanClusters4D_SeveralClusters(self):
