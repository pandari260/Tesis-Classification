...
from CRIO.Regionalization import defineHiperplane


class RegionalizationTest(unittest.TestCase):


    def test_defineHiperplane_trivial_2D(self):
        d = 2
        cluster = Cluster([(7.0,4.0)],d)
        group = Group([(5.0,4.0)],d)
        
        (piVars,alfa) = defineHiperplane(group, cluster)
    ...
    def test_defineHiperplane_severalSamples_2D(self):
        d = 2
    ...
    def test_defineHiperplane_trivial_3D(self):
        d = 3
    ...
    def test_defineHiperplane_severalSamples_3D(self):
        d = 3
    ...
    def test_defineHiperplane_trivial_4D(self):
        d = 4
    ...
    def test_defineHiperplane_severalSamples_4D(self):
        d = 4
