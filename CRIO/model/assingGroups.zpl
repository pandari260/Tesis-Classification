...
#parametros
    ...
    param k1 :=read routeParams as "1n" skip 6 use 1;#numero de clusters de clase 1
    ...
    param M := read routeParams as "1n" skip 7 use 1;#un numero positivo muy grande
