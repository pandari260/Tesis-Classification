...
#parametros
    ...
    #muestras de clase 0
    param m0 :=read routeParam as "1n" skip 2 use 1;#cantidad de muestras de clase 0;
    set M0 := {0 to m0-1};#etiquetas para las muestras de clase 0
    param Class0[M0*Ft] := read "class0.dat" as "<1n,2n> 3n"; 

    #muestras de clase 1
    param m1 :=read routeParam as "1n" skip 3 use 1;#cantidad de muestras de clase 1;
    set M1 := {0 to m1-1};#etiquetas para las muestras de clase 1
    param Class1[M1*Ft] := read "class1.dat" as "<1n,2n> 3n"; 


    #grupos
    param nk :=read routeParam as "1n" skip 4 use 1;
    ...
    param k1 :=read routeParam as "1n" skip 6 use 1;#numero de clusters de clase 1
    ...
    param M := read routeParam as "1n" skip 7 use 1;#un numero positivo muy grande
